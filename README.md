...
Any secure hashing algorithm can be used with PolyPassHash.   The [Python reference implementation](https://github.com/PolyPassHash/PolyPassHash-Python) uses SHA256.


<a name="implementation"/>
#### "Where can I get an implementation of PolyPassHash?"

For a readable implementation, check out the [PolyPassHash Python reference implementation](https://github.com/PolyPassHash/PolyPassHash-Python).   This is written for readability and not performance or practical use.   There are also a [C implementation](https://github.com/PolyPassHash/PolyPassHash-C) and a [Ruby implementation](https://github.com/PolyPassHash/PolyPassHash-Ruby) available.
...
[Our paper](https://github.com/PolyPassHash/PolyPassHash/blob/master/academic-writeup/paper.pdf) should be a good starting point.   If you have a question that is not covered there, feel free to email jcappos@nyu.edu.
