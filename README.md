...
This repository, contains the [PolyPassHash Python reference implementation](python-reference-implementation).   This is written for readability and not performance or practical use.   There are also a [C implementation](https://github.com/SantiagoTorres/PolyPassHash-C) and a [Ruby implementation](https://github.com/SantiagoTorres/PolyPassHash-Ruby) available.
